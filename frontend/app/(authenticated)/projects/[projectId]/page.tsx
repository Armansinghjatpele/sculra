      ...
      <PageHeader
        ...
        action={
          <div className="flex items-center gap-3">
            ...
            <Link href={`/projects/${projectId}/sources`}>
              <Button variant="outline" size="sm" className="inline-flex items-center gap-1.5 border-white/10 hover:border-accent/40">
            ...
            <Link href={`/projects/${projectId}/cicd`}>
              <Button variant="outline" size="sm" className="inline-flex items-center gap-1.5">
                ...
                <span>CI/CD Gates</span>
              </Button>
            </Link>
            <Link href={`/projects/${projectId}/fixes`}>
              <Button variant="outline" size="sm" className="inline-flex items-center gap-1.5">
